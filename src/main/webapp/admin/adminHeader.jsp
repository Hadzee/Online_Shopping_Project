...
<script src='https://kit.fontawesome.com/a076d05399.js'></script>
   ...
   <%String email = session.getAttribute("email").toString(); %>
            <center><h2>Online shopping (Tarik Hadzikic)</h2></center>
            ...
            <a href="messagesReceived.jsp">Received Messages <i class='fas fa-comment-alt'></i></a>
            <a href="ordersReceived.jsp">Received Orders <i class="fas fa-archive"></i></a>
