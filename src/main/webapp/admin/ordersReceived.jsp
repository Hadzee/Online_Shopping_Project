...
<body>
<div style="color: white; text-align: center; font-size: 30px;">Received Orders <i class="fas fa-archive"></i></div>
<%
String msg = request.getParameter("msg");
if("cancel".equals(msg))
{
%>
<h3 class="alert">Order successfully canceled.</h3>
<%}  %>
<%
          ...
          <th>Mobile Number</th>
            ...
            <th scope="col">Order Date</th>
             ...
             <th scope="col">Payment Method</th>
              ...
              <th scope="col">Cancel the order <i class='fas fa-window-close'></i></th>
              <th scope="col">Deliver the order <i class='fas fa-dolly'></i></i></th>
          </tr>
<%
